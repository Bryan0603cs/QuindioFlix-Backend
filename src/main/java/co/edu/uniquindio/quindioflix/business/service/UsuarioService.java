...
public interface UsuarioService {
    ...
    UsuarioResponse cambiarEstado(Long usuarioId, CambiarEstadoUsuarioCommand command);

    UsuarioResponse cambiarRol(Long usuarioId, CambiarRolUsuarioCommand command);

    Page<PagoResponse> pagos(Long usuarioId, Pageable pageable);
